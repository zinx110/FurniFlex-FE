...
export const PostProducts = () => {
    ...
    const validateFields = () => {
        ...
        if (
            productData.ImgUrl &&
            !/\.(jpg|jpeg|png|svg)$/i.test(productData.ImgUrl.name)
        ) {
        ...
        if (!productData.DiscountedPrice) {
            ...
            newErrors.DiscountedPrice =
                "Discounted price must be a positive value.";
            valid = false;
        }
            ...
            const response = await axios.post(
                ...
                formData,
                {
                    headers: {
                        ...
                        "Content-Type": "multipart/form-data", // Send JWT token for authentication
                    },
                }
            );
